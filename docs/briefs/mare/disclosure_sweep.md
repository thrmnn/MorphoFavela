...
- Lines [110, 113, 115]: INCLUDE (proposed) — matches the already-CLEAR release class of the WP-07 f4_geometry_constraints figure in red_lines.md §5 (ordinal geometry-only constraint count, denominator = built cells, not ranked).
