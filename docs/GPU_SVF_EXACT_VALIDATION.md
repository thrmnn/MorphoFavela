...
python scripts/compute_svf_streets_gpu.py \
  --stl /home/theo/MorphoFavela/data/riodaspedras/raw/full_scan.stl \
  --roads /home/theo/MorphoFavela/data/riodaspedras/raw/roads_riodaspedras.shp \
  --footprints /home/theo/MorphoFavela/data/riodaspedras/raw/riodaspedras_buildings.shp \
  --area riodaspedras \
  --spacing 3.0 \
  --height 1.5 \
  --sky-patches 145 \
  ...
  --output-dir /home/theo/MorphoFavela/outputs/riodaspedras/svf_streets_gpu_exact
```
...
python scripts/compute_svf_streets_gpu.py \
  ...
  --gpu-ray-chunk-size 1024 \
  --gpu-tri-chunk-size 4096 \
  --output-dir /home/theo/MorphoFavela/outputs/vidigal_tls/svf_streets_gpu_exact
```
...
```bash
python scripts/compute_svf_streets_gpu.py \
  --stl /home/theo/MorphoFavela/data/rocinha/rocinha.stl \
  --roads /home/theo/MorphoFavela/data/rocinha/raw/roads_rocinha.shp \
  --footprints /home/theo/MorphoFavela/data/rocinha/raw/rocinha_buildings.shp \
  --spacing 3.0 \
  --height 1.5 \
  --sky-patches 145 \
  --use-gpu \
  ...
  --gpu-ray-chunk-size 1024 \
  --gpu-tri-chunk-size 4096 \
  --output-dir /home/theo/MorphoFavela/outputs/rocinha/svf_streets_gpu_exact
```
