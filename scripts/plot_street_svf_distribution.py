...
def create_street_svf_distribution(
    ...
    ax.axvline(comfort_threshold, color='orange', linestyle=':', linewidth=2, 
...
def main():
    ...
    parser.add_argument('--comfort-threshold', type=float, default=0.3,
