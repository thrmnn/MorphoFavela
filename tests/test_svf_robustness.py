...
class TestInvalidInputs:
    ...
    def test_points_outside_bounds(self):
        ...
        test_points = np.array([[1000, 1000, 0], [-1000, -1000, 0]])
...
class TestBoundaryConditions:
    ...
    def test_extreme_evaluation_heights(self, height):
        ...
        svf_values = compute_svf(
            test_points, sky_patches, mesh, evaluation_height=height
        )
    ...
    def test_extreme_batch_sizes(self, batch_size):
        ...
        svf_values = compute_svf_gpu(
            observer_points, sky_patches_torch, pytorch3d_mesh, batch_size=batch_size
        )
...
class TestNumericalStability:
    ...
    def test_small_coordinates(self):
        ...
        test_points = np.array([[1e-6, 1e-6, 0], [1e-5, 1e-5, 0]])
    ...
    def test_large_coordinates(self):
        ...
        test_points = np.array([[1e6, 1e6, 0], [1e5, 1e5, 0]])
    ...
    def test_negative_elevation_points(self):
        ...
        test_points = np.array([[0, 0, -1], [10, 10, -0.5]])
...
class TestLargeDatasets:
    ...
    def test_many_points_gpu(self):
        ...
        svf_values = compute_svf_gpu(
            observer_points, sky_patches_torch, pytorch3d_mesh, batch_size=200
        )
