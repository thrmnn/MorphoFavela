...
class TestDataLoading:
    ...
    def test_load_building_polygons(self):
        ...
        buildings = gpd.GeoDataFrame(
            geometry=[box(0, 0, 10, 10), box(20, 20, 30, 30)], crs="EPSG:4326"
        )
    ...
    def test_load_road_network(self):
        ...
        roads = gpd.GeoDataFrame(
            geometry=[LineString([(0, 0), (10, 10)]), LineString([(20, 20), (30, 30)])],
            crs="EPSG:4326",
        )
...
class TestSpatialAlignment:
    ...
    def test_aligned_bounds(self):
        ...
        datasets = {"buildings": buildings, "roads": roads, "stl": stl_bounds}

        is_aligned, warnings, corrections = check_crs_alignment(
            datasets, tolerance=15.0
        )  # Large tolerance for overlapping bounds
...
class TestSTLAlignment:
    ...
    def test_stl_bounds_alignment(self):
        ...
        datasets = {"buildings": buildings, "stl": stl_bounds}
    ...
    def test_stl_mesh_alignment(self):
        ...
        datasets = {"buildings": buildings, "stl": mesh}
...
class TestRoadRedirection:
    ...
    def test_redirection_preserves_network(self):
        ...
        buildings = gpd.GeoDataFrame(geometry=[box(5, 5, 10, 10)], crs="EPSG:4326")
...
class TestIntegration:
    ...
    def test_full_alignment_pipeline(self):
        ...
        is_aligned_after, warnings_after, _ = check_crs_alignment(
            corrected,
            tolerance=1.0,  # More lenient after correction
        )
