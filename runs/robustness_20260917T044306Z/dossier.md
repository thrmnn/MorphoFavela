...
Generated 2026-09-17T04:43:06Z · status: staged

Ledger used: `runs/wp07_ledger_20260916T164906Z/ledger.json` (371 entries, run 2026-09-16T16:49:06Z, status final)
...
Engine acceptance rests on two independent legs: (1) three analytic self-checks against closed-form geometry (no data dependency), and (2) a measured cross-reference against the CPU raycaster's street SVF at Rio das Pedras (16,905 points). Both are read here, not recomputed.

| id | value | unit | source |
|---|---|---|---|
| `engine.crossref.r` | 0.9945 | dimensionless | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/engine.crossref.r/value` |
| `engine.crossref.median_abs_delta` | 0.01372 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/engine.crossref.median_abs_delta/value` |
| `engine.crossref.p95_abs_delta` | 0.04738 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/engine.crossref.p95_abs_delta/value` |
...
| id | value | unit | source |
|---|---|---|---|
| `g3.spread.complexo_do_alemao.svf_percentile` | 8.283 | percentile points | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/complexo_do_alemao/svf_percentile_spread_max_minus_min` |
| `g3.spread.mare.svf_percentile` | 3.569 | percentile points | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/mare/svf_percentile_spread_max_minus_min` |
| `g3.spread.riodaspedras.svf_percentile` | 3.195 | percentile points | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/riodaspedras/svf_percentile_spread_max_minus_min` |
| `g3.spread.rocinha.svf_percentile` | 1.275 | percentile points | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/rocinha/svf_percentile_spread_max_minus_min` |
| `g3.spread.vidigal.svf_percentile` | 4.28 | percentile points | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/vidigal/svf_percentile_spread_max_minus_min` |
| `g3.rank_under_locked_domain` | complexo_do_alemao, rocinha, vidigal, riodaspedras, mare | ordered list | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/rank_under_locked_domain` |
| `g3.rank_invariant_across_grid` | True | boolean | `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/rank_invariant_across_grid` |
| `g3.spread.min_across_favelas` | 1.275 | percentile points | computed (min) from `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/vidigal/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/rocinha/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/complexo_do_alemao/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/mare/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/riodaspedras/svf_percentile_spread_max_minus_min` |
| `g3.spread.max_across_favelas` | 8.283 | percentile points | computed (max) from `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/vidigal/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/rocinha/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/complexo_do_alemao/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/mare/svf_percentile_spread_max_minus_min`; `runs/wp07_ledger_20260916T164906Z/ledger.json#/derived/spread/riodaspedras/svf_percentile_spread_max_minus_min` |

## 3. Sky resolution

P1_SKY_PATCHES = 145 (imported from src/brisa_solar/constants.py, never typed as a literal in any P1 module — tests/test_p1_sky_resolution_consistency.py enforces this by AST). Scanning every run manifest under the main checkout (93 manifests, 93 carrying a sky.patches field): exactly one resolution appears — [145]. No second resolution exists in any code path feeding a pooled number.
...
| `wp06.vidigal.n` | 2756 | count | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.vidigal.n/value` |
| `wp06.vidigal.share_n0` | 0.2032 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.vidigal.share_n0/value` |
| `wp06.vidigal.share_n1` | 0.3988 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.vidigal.share_n1/value` |
| `wp06.vidigal.share_n2` | 0.3295 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.vidigal.share_n2/value` |
| `wp06.vidigal.share_n3` | 0.06858 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.vidigal.share_n3/value` |
| `wp06.rocinha.n` | 8031 | count | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.rocinha.n/value` |
| `wp06.rocinha.share_n0` | 0.105 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.rocinha.share_n0/value` |
| `wp06.rocinha.share_n1` | 0.2959 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.rocinha.share_n1/value` |
| `wp06.rocinha.share_n2` | 0.5301 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.rocinha.share_n2/value` |
| `wp06.rocinha.share_n3` | 0.06911 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.rocinha.share_n3/value` |
| `wp06.complexo_do_alemao.n` | 17768 | count | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.complexo_do_alemao.n/value` |
| `wp06.complexo_do_alemao.share_n0` | 0.1738 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.complexo_do_alemao.share_n0/value` |
| `wp06.complexo_do_alemao.share_n1` | 0.3791 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.complexo_do_alemao.share_n1/value` |
| `wp06.complexo_do_alemao.share_n2` | 0.3439 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.complexo_do_alemao.share_n2/value` |
| `wp06.complexo_do_alemao.share_n3` | 0.1033 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.complexo_do_alemao.share_n3/value` |
| `wp06.riodaspedras.n` | 6605 | count | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.riodaspedras.n/value` |
| `wp06.riodaspedras.share_n0` | 0.0321 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.riodaspedras.share_n0/value` |
| `wp06.riodaspedras.share_n1` | 0.1257 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.riodaspedras.share_n1/value` |
| `wp06.riodaspedras.share_n2` | 0.2883 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.riodaspedras.share_n2/value` |
| `wp06.riodaspedras.share_n3` | 0.554 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.riodaspedras.share_n3/value` |
| `wp06.mare.n` | 29229 | count | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.mare.n/value` |
| `wp06.mare.share_n0` | 0.09833 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.mare.share_n0/value` |
| `wp06.mare.share_n1` | 0.2433 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.mare.share_n1/value` |
| `wp06.mare.share_n2` | 0.3385 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.mare.share_n2/value` |
| `wp06.mare.share_n3` | 0.3199 | fraction | `runs/wp07_ledger_20260916T164906Z/ledger.json#/entries/wp06.mare.share_n3/value` |
...
- `runs/wp07_ledger_20260916T164906Z/ledger.json`
